...
var main = {
  ...
  create: function() { 
	  ...
	  //donot allow the paddle to go beyond the screen
	...
	this.ball.body.rotation = 200;
	//this.ball.body.angularVelocity = 200;
  ...
  update: function() {
    // This function is called 60 times per second    
     ...
     //console.log();
      if(this.ball.body.position.y>420){
          alert("Game Over!!");
